    ...
    >
      <View className="flex-row items-center justify-between">
        ...
        <View className="items-center">
          <Text className="text-base font-bold text-gray-900">Cart</Text>
          <TouchableOpacity
    ...
    <View style={{ flex: 1, backgroundColor: "#F4F4F4" }}>
      ...
      {displayItems.length === 0 ? (
        <View className="flex-1 items-center justify-center gap-2 px-6">
          <View className="w-20 h-20 rounded-full bg-primary-tint items-center justify-center mb-2">
        ...
        <>
          ...
          >
            <View className="bg-white rounded-xl p-4">
              ...
              <TouchableOpacity
                activeOpacity={0.7}
                className="border border-primary/50 bg-primary-tint rounded-xl px-4 py-2.5 flex-row items-center justify-between"
              >
                <Text className="text-sm font-inter-semibold text-primary-dark">
                  ...
                  <View key={String(item.variation_id)}>
                    ...
                    <View className="flex-row items-center gap-3">
                      ...
                      <View className="flex-1">
                        ...
                        {item.discount_type && (
                          <View className="flex-row items-center gap-1 mt-0.5">
                            <View className="bg-primary-tint px-1.5 py-0.5 rounded">
                              <Text className="text-xxs font-bold text-primary-dark">
                      ...
                      <View className="flex-row items-center rounded-lg overflow-hidden bg-primary">
                        <TouchableOpacity
                        ...
                        <Text className="max-w-10 min-w-6 text-center font-inter-bold text-xs text-white">
                          {item.total_quantity}
                        </Text>
                        <TouchableOpacity
            ...
            <View className="bg-white rounded-xl p-4">
              ...
              <View className="gap-3">
                <View className="flex-row justify-between items-center">
                  <View className="flex-row items-center gap-2">
                    <Text className="text-xs text-gray-600">Cart Value</Text>
                    {discount > 0 && (
