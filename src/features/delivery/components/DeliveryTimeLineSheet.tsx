...
const getStatusIcon = (status: TimelineEvent["status"], index: number) => {
  ...
  const pendingIcons = [
    <Clock key="clock" color="#9CA3AF" {...iconProps} />,
    <Package key="package" color="#9CA3AF" {...iconProps} />,
    <Truck key="truck" color="#9CA3AF" {...iconProps} />,
    <MapPin key="mappin" color="#9CA3AF" {...iconProps} />,
    <CheckCircle key="check" color="#9CA3AF" {...iconProps} />,
  ];
