                ...
                : subcategory?.result.map((item) => {
                    ...
                    return (
                      <TouchableOpacity
                        ...
                        activeOpacity={0.7}
                        className={`items-center py-4 px-1 relative ${isActive ? "bg-primary-tint" : ""}`}
                      >
                        {isActive && (
                          <View className="absolute left-0 top-2 bottom-2 w-1 bg-primary rounded-r-full" />
                        )}
                        <View className="w-12 h-12 bg-white rounded-lg items-center justify-center p-1 mb-1">
                          <Image
                        ...
                        <Text
                          className={`text-[10px] text-center px-1 ${isActive ? "text-slate-900 font-inter-bold" : "text-gray-500 font-medium"}`}
                        >
                          {item.title}
                        </Text>
                      </TouchableOpacity>
