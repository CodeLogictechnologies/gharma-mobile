...
const GuestProfile = () => (
  <View className="flex-1 bg-secondary">
    ...
    <View className="flex-1 bg-white rounded-t-2xl mt-2 items-center justify-center px-8">
      {/* Avatar placeholder */}
      <View className="w-24 h-24 rounded-full bg-gray-100 items-center justify-center mb-5 border-2 border-orange-100">
      ...
      <TouchableOpacity
        ...
        className="w-full bg-primary rounded-xl py-3.5 items-center mb-3 flex-row justify-center gap-2"
      >
      ...
      <TouchableOpacity
        onPress={() => router.navigate("/(auth)/login")}
        className="w-full border border-orange-400 rounded-xl py-3.5 items-center flex-row justify-center gap-2"
      >
