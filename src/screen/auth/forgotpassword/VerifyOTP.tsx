      ...
      >
        <View className="flex-1 px-6 pt-10 pb-8">
                    ...
                    {Array(6)
                      ...
                      .map((_, index) => {
                        ...
                        return (
                          <View
                            key={index}
                            className={`w-12 h-14 border-2 rounded-md justify-center items-center bg-gray-50 ${
          ...
          <TouchableOpacity
            ...
            disabled={isPending}
            className={`bg-primary py-2.5 rounded-md flex-row justify-center items-center shadow-sm ${
